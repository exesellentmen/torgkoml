...
<head>
	...
	*/?>
	...
	<!--  - Отображает специальные стили, JavaScript попробовать перенести в футер -->

	<? $APPLICATION->ShowHeadScripts() ?>
	<!--  - Вывода служебных скриптов попробовать перенести в футер -->
	...
	<link rel="stylesheet" href="/local/templates/eshop_bootstrap_v4/assets/css/app.css">
	<!--[if lt IE 9]>
    <script src="http://cdnjs.cloudflare.com/ajax/libs/html5shiv/3.7.2/html5shiv.min.js"></script><![endif]-->

	<!-- Корректировки -->
	<link href="/local/templates/eshop_bootstrap_v4/assets/css/stylestartpv.css" rel="stylesheet">
	<link href="/local/templates/eshop_bootstrap_v4_copy/assets/css/mobilemenu.css" rel="stylesheet">
...
<body style="    overflow-x: hidden;" class="eeee">
...
<div id="panel"><? $APPLICATION->ShowPanel(); ?>
	...
	*/?>
	...
	<?$APPLICATION->IncludeComponent("bitrix:news.list", "menumobi", Array(
