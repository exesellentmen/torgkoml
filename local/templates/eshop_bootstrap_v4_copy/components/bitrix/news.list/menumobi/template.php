...
<style>
	...
	.testarrow:first-child:not(:only-of-type),
	.activeheader {
		background-size: 12px;

	}

	.activeheader .cellimg,
	.activeheader .cellhead {
...
*/
	...
	.index-smo-list__items.soc {
		width: 80%;
		margin: 0 auto;

	}

	.index-smo-list__item.toggleTitle.soc {
		margin: 0 auto;
	...
	.index-smo-list__item {
		margin-left: calc((100% - 206px) / 5) !important;

	}

	.index-smo-list__items {
		width: 100% !important;
...
"></div>
		...
		<div class="upkont" style="padding-left: 10px;
    padding-right: 10px;
    color: #000000;
    vertical-align: middle;
    width: calc(72.6% - 200px);
    margin-left: auto;
    margin-right: auto;">
    ...
    text-align: center;
">
				<div class="phones1 pvcont" style="display: inline-block;">8 (800) 302-02-90<br>8 (800) 302-02-90</div>
				<div style="padding: 0 24px 24px 0;display: inline-block; background: url(/local/templates/eshop_bootstrap_v4/assets/img/whatsapp.png) no-repeat 0 0;"></div>
			</div>

			<div class="adress1 pvcont" style="width: 48%;    display: inline-block;">
				<div>
		...
		<div class="icomenufix cart"><a href="/personal/cart/" style="    text-decoration: dashed !important;"><span class="lnr lnr-cart vertmiddle"></a></span></div>
...
">
		...
		<div class='drodownsection'>
			...
			<!-- Заголовок -->
			<div class='headdrodown testarrow'  style='padding-top: 31px !important;    padding-bottom: 31px !important;'>
		...
		if ($el = $res2->Fetch()){
			...
			<div class='drodownsection testarrow'>
				...
				<div class='allgoods' style='background-color: #EEEEEE; padding: 31px 8px 31px 70px;'>
			...
			<div style="    margin: 0 auto;    width: max-content; text-align: center; width: 100%;">
				...
				<div class="index-smo-list  soc">
					...
					<a class="index-smo-list__item toggleTitle instpv soc" href="#" data-title="Instagram">
                        ...
                        <div class="icon-facebook  soc fa fa-facebook"></div></a>
						
						<a class="index-smo-list__item toggleTitle soc" href="#" data-title="Twitter">
                        <div class="icon-twitter  fa fa-twitter  soc"></div></a>
					...
					*/?>
						...
						<div class="index-smo-list__items"><a class="index-smo-list__item toggleTitle instpv" href="#" data-title="Instagram">
								<div class="icon-inst"></div>
							</a><a class="index-smo-list__item toggleTitle" href="#" data-title="Vkontakte">
								<div class="icon-vk"></div>
							</a><a class="index-smo-list__item toggleTitle" href="#" data-title="Facebook">
								<div class="icon-facebook"></div>
							</a><a class="index-smo-list__item toggleTitle" href="#" data-title="Twitter">
...
">
    ...
    width: 100%;
">
		<div class="phones1 pvcont">8 (800) 302-02-90<br>8 (800) 302-02-90</div>
		<div style="padding: 0 24px 24px 0;display: table-cell;background: url(/local/templates/eshop_bootstrap_v4/assets/img/whatsapp.png) no-repeat 0 0;"></div>
		<div class="adress1 pvcont">
		...
		<div class="header-top__col two">
			<div class="header-top-search">
				<form class="header-top-search__form" action="" method="get">
					<div class="header-top-search__wrap se700">
	...
	<div class="btnpv700" style="    margin-top: 25px; padding-bottom: 16px;">
...
*/
	...
	$(".panelmenu > .drodownmenu > .drodownsection").height()

	$('.btncls').css("display", "none");


	$('.btncls').height($('.btncls').outerWidth());
	$('.btncls').css("line-height", $('.btncls').outerWidth() + "px");
	...
	$('.burger').on('click', function() {
		...
		if (start) {
			var po1 = $(".panelmenu > .contt > .drodownmenu > .drodownsection").height();
		...
		//		$('body > *:not(.panelmenu):not(.menufix):not(.btncls').addClass('blurr');
	...
	$('.headdrodown').on('click', function() {
		...
		if ($(this).hasClass('activeheader')) {
			...
			if ($(this).parent('.drodownsection').parent('.drodownsection').siblings('.headdrodown').height()) {
				...
				var po = $(this).parent('.drodownsection').parent('.drodownsection').siblings('.headdrodown').outerHeight();


				$('.contt').css("margin-top", (po + 50) + "px");

				$('.contt').css("height", "calc(100% - " + (po + 50) + "px)");


			} else {

				$('.contt').css("margin-top", "51px");

				$('.contt').css("height", "calc(100% - 51px)");
...
<div class="scrollHeader__col three">
	<div class="scrollHeader-control"><a class="scrollHeader-control__link toggleTitle" href="#" data-title="Сравнение">
			<div class="scrollHeader-control__link-icon lnr lnr-sort-amount-asc"></div>
		</a><a class="scrollHeader-control__link toggleTitle" href="#" data-title="Избранное">
			<div class="scrollHeader-control__link-icon lnr lnr-heart"></div>
		</a></div>
