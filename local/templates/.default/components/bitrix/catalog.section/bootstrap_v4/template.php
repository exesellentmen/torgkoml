...
<div class="row<?=$themeClass?>"> <? // wrapper ?>
	...
	*/?>
	...
	<?
	// Для навигации при показе верх страницы(на данный момент не выводит)
	//region Pagination
	if ($showTopPager)
	{
		?>
	...
	//region Description(на данный момент не выводит)
	...
	?>
		...
		<?// Старый вывод очень важный параметр  data-entity="$containerName"?>
	<?/*	<div class="mb-4 catalog-section" data-entity="<?=$containerName?>"> */?>
		
		
		<div  data-entity="<?=$containerName?>" style="width:100%">
			...
			if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
			{
				...
				foreach ($arResult['ITEM_ROWS'] as $rowData)
				{
					...
					<?// Старый вывод очень важный параметр  data-entity="items-row"?>
					<?/*<div class="row <?=$rowData['CLASS']?>" data-entity="items-row">*/?>
					<div data-entity="items-row" style="width:100%" class="sectionCatalogList-items">
...
?>
			...
			<div class="sectionCatalogNav" style="margin: 40px auto;">
	<div class="sectionCatalogNav__title">Вы посмотрели 180  из  480</div>
			
			
			
			
			<div data-entity="lazy-<?=$containerName?>" onclick="
			
			tt44 = tt44+<?=$arResult[ORIGINAL_PARAMETERS][PAGE_ELEMENT_COUNT];?>;
			$('.sectionCatalogNav__title').text('Вы посмотрели '+tt44+' из <?=$cnt;?>');
			
			">
			<button type="button" class="sectionCatalogNav__additems" data-use="show-more-<?=$navParams['NavNum']?>"
			style="
				display: flex;
