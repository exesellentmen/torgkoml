...
<?//Здесь проверять ссылку?>



<? //Формирование ссылки

$url11 = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
$url11 = str_replace(":80", "", $url11);
$url22 = ((!empty($_SERVER['HTTPS'])) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'];
$url22 = str_replace(":80", "", $url22);
...
if (CModule::IncludeModule('highloadblock')) {
	...
	while ($res1 = $result->fetch()) {
		// Выводите что вам надо
		array_push($generalcolors, array("Name" => $res1[UF_NAME], "file" => $res1[UF_FILE]));
	}
	...
	$result = $hlDataClass::getList(array(
		"select" => array("ID", "UF_NAME", "UF_XML_ID", "UF_FILE"), // Поля для выборки
		"order" => array("UF_SORT" => "ASC"),
		"filter" => array("UF_XML_ID" => $arResult[PROPERTIES][colorsvariant][VALUE])

	));

	while ($res1 = $result->fetch()) {
		// Выводите что вам надо
		array_push($generalcolorsdrugcveta, array("Name" => $res1[UF_NAME], "file" => $res1[UF_FILE]));
	}
...
<? //Поделиться 
/*
$textshare = 'Товар: "' . $arResult[NAME] . '" от ';
echo $textshare;
*/
?>
<?/*
...
<div class="ya-share2" data-services="collections,vkontakte,facebook,odnoklassniki,moimir,whatsapp" data-image="<?= $url22; ?>/upload/iblock/4c3/4c3a4ddbbe3aeef2e7631521001ba7d5.jpg"></div>
*/ ?>
...
<style>
	...
	.catalogDetail-tabs-tab__btn:hover {
		background: #616161;
...
<style>
	...
	*/
	...
	.sectionCatalogList-items-prev-price__buy:hover {
		background-color: #ff4500 !important;
		color: #fff !important;
		border: unset !important;
	}

	.catalogDetailInfo-buy__link,
	.catalogDetailInfo-buy__link.two {
		display: none;
	}
</style>
...
<style>
	<? //Карусель, убираем фон и добавляем полоски?>
</style>
...
<style>
	...
	.share-popup__icon {
		border: 1px solid #65656b !important;
...
<div class="deskver">
	...
	<?
		...
		//	print_r($arResult[ORIGINAL_PARAMETERS][SECTION_CODE]);

		$SectList = CIBlockSection::GetList(array(), array(
			"IBLOCK_ID" => 6,
			"ACTIVE" => "Y",
			//	"CODE" => "testovyy-razdel", //$arResult[ORIGINAL_PARAMETERS][SECTION_CODE],
									...
									<div class="catalogDetailPhoto-big__popup one">
										<div class="lnr lnr-exit-up catalogDetailPhoto-big__icon toggleTitle" data-title="Поделиться">
											...
											?>
												...
												<a class="share-popup__item" title="Копировать ссылку" href="javascript:void(0);" onclick="var $tmp = $('<textarea>');$('body').append($tmp);	var qq1 = window.location.href;$tmp.val(qq1).select();
    document.execCommand('copy');$tmp.remove();">
					...
					<div class="catalogDetail-hero__col two">
						<div class="catalogDetailInfo">
							...
							<div class="catalogDetailInfo-prop__items">
								...
								<?//Вывод цветов1?>
								<div class="imgarr1" style="display:none; cursor: pointer;" onclick="document.location = '<?= $APPLICATION->sDirPath; ?>';">
									<? foreach ($generalcolorsdrugcveta as $key => $valueimg) {?>
									<div class='img12' title="<?= $valueimg[Name]; ?>" style="background-image: url('<?= CFile::GetPath($valueimg[file]); ?>');"></div>
									<? } ?>

									<div class="sectionCatalogList-items-prev-price__col one" style="opacity:1;display: inline-block;vertical-align: middle;margin-left: 10px;"><span class="sectionCatalogList-items-prev-price__link">Другие размеры</span></div>

									<div class="sectionCatalogList-items-prev-price__col one" style="opacity:1;display: inline-block;vertical-align: middle;margin-left: 10px;"><span class="sectionCatalogList-items-prev-price__link">Другие цвеа</span></div>
								...
								<div>
									<button class="index-project-info-btn__callback btn-common-empty alldisaignpv btnurl" style="display:none; margin: 30px 0px 0px;" onclick="document.location = '<?= $APPLICATION->sDirPath; ?>';">Подробнее о товаре</button>
								</div>
							...
							<? //               Начало вывода вариантов товара                       
							?>
							<? //==================================================================================================================
							?>
							<? //==================================================================================================================
			...
			<br class="godund"><br class="godund"><br class="godund">

			<h2 class="catalogDetailInfo-prop__title godund">Другие варианты товара :</h2>
...
<tr>
	...
	<td style=''>Цена</td>
			...
			<td style='' class='pricvar1'>" .
				...
				echo "<br class='godund'><br class='godund'><br class='godund'><br class='godund'>";
		...
		?>
				...
				<style>
					<?= ($artest[obrabotka] ? "" : ".obrabotka-column{display:none;}"); ?><?= ($artest[height] ? "" : ".height-column{display:none;}"); ?><?= ($artest[size] ? "" : ".size-column{display:none;}"); ?><?= ($artest[width] ? "" : ".width-column{display:none;}"); ?><?= ($artest[deep] ? "" : ".deep-column{display:none;}"); ?><?= ($artest[tolchina] ? "" : ".tolchina-column{display:none;}"); ?><?= ($artest[diametr] ? "" : ".diametr-column{display:none;}"); ?>.tabvariant {
						text-align: left;
					}
...
*/?>
	...
	<style>
		...
		.mobi .sectionCatalogList-items-prev-control__col.two {
		...
		?>
			...
			<div class="sectionCatalogList-items-prev-control__col one">
				<div class="sectionCatalogList-items-count" style="vertical-align: middle;">
					<div class="sectionCatalogList-items-count__col" style="margin-right: 17px;">
						<button class="sectionCatalogList-items-count__btn minus" style="font-size: 18px;
    width: 50px;
    height: 50px;">-</button>
					</div>
					<div class="sectionCatalogList-items-count__col" style="vertical-align: middle;">
						<div class="sectionCatalogList-items-count__input" style="vertical-align: middle;">
							<input class="sectionCatalogList-items-count__input-text" type="text" value="1" style="vertical-align: middle; margin:5px;">
						</div>
					</div>
					<div class="sectionCatalogList-items-count__col" style="margin-left: 17px;">
						<button class="sectionCatalogList-items-count__btn plus" style="font-size: 18px;
    width: 50px;
    height: 50px;">+</button>
					</div>
				</div>
...
?>
	...
	?>
		...
		<div class="plancol1">
			...
			<?/*
		<h2 class="catalogDetailInfo-prop__title">Краткое описание</h2>
	...
	$(".buy-but1").click(function() {
		...
		$.ajax({
			...
			success: function(out) {
				...
				//     alert("готово. Перейти в корзину <?= $url22; ?>/personal/cart/");
...
<script>
	$("body").on({
		mouseenter: function() {
			...
			//$('.showbox1').css('top',(($(this).position().top+$(this).height()) + 'px'));
...
<style>
	...
	/* Скрыл вкладку */
	.catalogDetail-tabs__items .catalogDetail-tabs__item:nth-child(3) {
		display: none;
	...
	.catalogDetail-tabs__item {
		text-decoration: dashed !important;
		color: #717171 !important;

	}

	.catalogDetail-tabs__item.active {
		color: #2f2f2f !important;
	}
	...
	.catalogDetailPhoto-big__popup.two {
		text-decoration: dashed !important;
	}
...
if($arResult[PROPERTIES][torgsist][VALUE][0]){
...
// Устанавливаем фильтр для вывода товаров торговых систем
$torgoggerid11 =[];
//Вывод всех указателей у этого элемента(Правильно)
foreach ($arResult[PROPERTIES][torgsist][VALUE] as $itemoffer11) {
	array_push($torgoggerid11, $itemoffer11);
}
$result11 = array_unique($torgoggerid11);
$arFilter3_linksnew11 = array(
	"IBLOCK_ID" => 6,
	"XML_ID" => $result11,
	"ACTIVE" => "Y"
...
//Выбор фильтра
global $arrFilter;
$arrFilter =$arFilter3_linksnew11;
?>
...
,
    ...
    "OFFERS_LIMIT" => "0",
    "SECTION_ID" => "122",
    "SECTION_CODE" => "Tovary-torgovykh-sistem",
    "SECTION_URL" => "/katalog-tovarov-3/#SECTION_CODE_PATH#/",
    "DETAIL_URL" => "/katalog-tovarov-3/#SECTION_CODE_PATH#/#ELEMENT_CODE#/",
    ...
    "ADD_TO_BASKET_ACTION" => "ADD",
    "SHOW_CLOSE_POPUP" => "N",
    "COMPARE_PATH" => "/katalog-tovarov-3/compare/",
    "COMPARE_NAME" => "",
    "USE_COMPARE_LIST" => "Y",
    "BACKGROUND_IMAGE" => "-",
    "COMPATIBLE_MODE" => "N",
...
<div class="cardshow33" id='cardshow33'>
...
BX.ajax.insertToNode('/katalog-tovarov-3/?bxajaxid=cardshow&test=y', 'cardshow33');
</script>
...
<style>
.cardshow33 .header, .cardshow33 .breadcrumbs, .cardshow33 .pvcataloglist, .cardshow33 .comman_h1{
	display: none;
}

.catalogDetailInfo-prop__title.godund, .descdescription, .godund{
	display: none;
}
</style>
			...
			<div class="container__wrap">
				<div class="propductLine__wrap">
					<div class="propductLine__col one">
						<div class="propductLine-item">
							<div class="propductLine-item__col one">
								<div class="propductLine__pic"><img class="propductLine__img" src="assets/img/page/detail_catalog/big.png" alt=""></div>
							</div>
							<div class="propductLine-item__col two">
								<div class="propductLine__name">
					...
					<div class="propductLine__col two">
						<div class="propductLine-prop">
							<div class="propductLine-prop__col one"><a class="propductLine-prop__back-prop" href="#product_prop">Вернуться к характеристикам</a></div>
							<div class="propductLine-prop__col two">
								<div class="popupAddBasket-item-count">
									<div class="popupAddBasket-item-count__col one">
	...
	<div class="catalogDetail">
		<div class="container">
				...
				<div class="catalogDetail-hero">
					<div class="catalogDetail-hero__col one">
						<div class="catalogDetailPhoto">
								...
								<div class="catalogDetailPhoto-mini">
									<div class="catalogDetailPhoto-mini__items">
										<div class="catalogDetailPhoto-mini__item">
											<div class="catalogDetailPhoto-mini__pic"><img class="catalogDetailPhoto-mini__img" src="assets/img/page/detail_catalog/mini.png" alt="" /></div>
										</div>
										<div class="catalogDetailPhoto-mini__item">
											<div class="catalogDetailPhoto-mini__pic"><img class="catalogDetailPhoto-mini__img" src="assets/img/page/detail_catalog/mini.png" alt="" /></div>
										</div>
							...
							<div class="catalogDetailPhoto__col two">
								<div class="catalogDetailPhoto-big">
									<div class="catalogDetailPhoto-big__popup three"><span class="catalogDetailPhoto-big__toggleTitle toggleTitle" data-title="Смотреть">
											<div class="lnr lnr-camera-video catalogDetailPhoto-big__icon"></div>
											<div class="catalogDetailPhoto-big__popup-title" data-show="видео" data-hide="смотреть">видео</div>
										</span></div>
									<div class="catalogDetailPhoto-big__popup one">
										<div class="lnr lnr-exit-up catalogDetailPhoto-big__icon toggleTitle" data-title="Поделиться"></div><span class="share-popup"><span class="share-popup__items"><a class="share-popup__item" href="#"><span class="fa fa-instagram share-popup__icon"></span></a><a class="share-popup__item" href="#"><span class="fa fa-vk share-popup__icon"></span></a><a class="share-popup__item" href="#"><span class="fa fa-facebook share-popup__icon"></span></a><a class="share-popup__item" href="#"><span class="fa fa-twitter share-popup__icon"></span></a><a class="share-popup__item" href="#"><span class="fa fa-whatsapp share-popup__icon"></span></a></span></span>
									</div><a class="catalogDetailPhoto-big__popup two" id="js-catalogDetailPhoto-fancybox" data-fancybox="gallery" href="assets/img/page/detail_catalog/big.png">
										<div class="lnr lnr-frame-expand catalogDetailPhoto-big__icon toggleTitle" data-title="Увеличить"></div>
									</a>
									<div class="catalogDetailPhoto-big__items">
										<div class="catalogDetailPhoto-big__item"><a class="catalogDetailPhoto-big__pic" data-fancybox="gallery-img" href="assets/img/page/detail_catalog/big.png"><img class="catalogDetailPhoto-big__img" src="assets/img/page/detail_catalog/big.png" alt="" /></a></div>
										<div class="catalogDetailPhoto-big__item"><a class="catalogDetailPhoto-big__pic" data-fancybox="gallery-img" href="assets/img/page/detail_catalog/big.png"><img class="catalogDetailPhoto-big__img" src="assets/img/page/detail_catalog/big.png" alt="" /></a></div>
										<div class="catalogDetailPhoto-big__item"><a class="catalogDetailPhoto-big__pic" data-fancybox="gallery-img" href="assets/img/page/detail_catalog/big.png"><img class="catalogDetailPhoto-big__img" src="assets/img/page/detail_catalog/big.png" alt="" /></a></div>
										<div class="catalogDetailPhoto-big__item"><a class="catalogDetailPhoto-big__pic" data-fancybox="gallery-img" href="assets/img/page/detail_catalog/big.png"><img class="catalogDetailPhoto-big__img" src="assets/img/page/detail_catalog/big.png" alt="" /></a></div>
										<div class="catalogDetailPhoto-big__item"><a class="catalogDetailPhoto-big__pic" data-fancybox="gallery-img" href="assets/img/page/detail_catalog/big.png"><img class="catalogDetailPhoto-big__img" src="assets/img/page/detail_catalog/big.png" alt="" /></a></div>
					...
					<div class="catalogDetail-hero__col two">
						<div class="catalogDetailInfo">
							...
							<div class="catalogDetailInfoTags"><a class="catalogDetailInfoTags__link" href="#">Торговые системы не требующие крепления к стене</a><a class="catalogDetailInfoTags__link" href="#">Вертикальные торговые системы</a><a class="catalogDetailInfoTags__link" href="#">Вешала стойки напольные</a><a class="catalogDetailInfoTags__link" href="#">Вешала из нержавейкинержавейки</a><a class="catalogDetailInfoTags__link" href="#">Вешала</a><a class="catalogDetailInfoTags__link" href="#">Вешала напольные</a>
							</div><a name="product_prop"></a>
							<h1 class="catalogDetailInfo__title">Вешало напольное латунь st-02.90-latun для одежы и шуб, ремней и обуви Вешало напольное латунь st-02.90-latun</h1>
							<div class="catalogDetailInfo-buy">
								<div class="catalogDetailInfo-buy__col one">
									<div class="catalogDetailInfo-buy__price-old">17 250 руб.-</div>
									<div class="catalogDetailInfo-buy__price">23 900 руб.-</div><a class="catalogDetailInfo-buy__link" href="#">сравнить</a><a class="catalogDetailInfo-buy__link two" href="#">в избранное</a>
								</div>
								...
								<div class="catalogDetailInfo-buy__col three">
									<div class="catalogDetailInfo-buy-count">
										<div class="catalogDetailInfo-buy-count__col one">
											<button class="catalogDetailInfo-buy-count__btn" data-type="minus">-</button>
										</div>
										<div class="catalogDetailInfo-buy-count__col two">
											<div class="catalogDetailInfo-buy-count-input">
												<input class="catalogDetailInfo-buy-count-input__text" type="text" value="1" />
											</div>
										</div>
							...
							<div class="catalogDetailInfo-prop-select">
								<div class="catalogDetailInfo-prop-select__value">1200*450*1200 мм, сечение 40*40 мм</div>
								<div class="catalogDetailInfo-prop-select__items">
			...
			<div class="container__wrap">
				<div class="catalogDetail-tabs">
					<div class="catalogDetail-tabs__wrap">
						<div class="catalogDetail-tabs__items"><a class="catalogDetail-tabs__item active" href="#">Описание товара</a><a class="catalogDetail-tabs__item" href="#">Нет нужного размера или цвета?</a><a class="catalogDetail-tabs__item" href="#">Доставка и оплата</a><a class="catalogDetail-tabs__item" href="#">Частые вопросы</a></div>
						<div class="catalogDetail-tabs-tab">
							<div class="catalogDetail-tabs-tab__item active">
								<div class="catalogDetail-tabs-tab__wrap">
									<div class="catalogDetail-tabs-tab__col one">
				...
				<div class="product-item-detail-pay-block">
					...
					<div class="mb-3">
						...
						<?
										...
										{
											?>
						<div class="product-item-detail-economy-price mb-1" id="<?= $itemIds['DISCOUNT_PRICE_ID'] ?>" <?= ($showDiscount ? '' : 'style="display: none;"') ?>>
							<?
													if ($showDiscount)
													{
