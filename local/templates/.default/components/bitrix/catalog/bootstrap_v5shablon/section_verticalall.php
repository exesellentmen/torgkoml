...
.row2{
    ...
    font-weight: 700;
    font-size: 1.3rem;
    border-bottom: 3px solid #987fc2;
}
...
<?/*Начало фильтра*/?>
<?
	$APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "bootstrap_v45", array(
			"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
			"IBLOCK_ID" => $arParams["IBLOCK_ID"],
			//"SECTION_ID" => "",//$arCurSection['ID'],
			"FILTER_NAME" => $arParams["FILTER_NAME"],
			...
			"SEF_RULE" => "/katalog-tovarov-3/filter/#SMART_FILTER_PATH#/apply/",
