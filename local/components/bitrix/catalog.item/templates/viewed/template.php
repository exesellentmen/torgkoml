...
<?/*
	<div class="sectionCatalogList-items__item<?=(isset($arResult['SCALABLE']) && $arResult['SCALABLE'] === 'Y' ? ' product-item-scalable-card' : '')?>"
		id="<?=$areaId?>" data-entity="item">
		*/?>
		
	<div class="elem" id="<?=$areaId?>" data-entity="item">	
