					...
					"></div>
					  ...
					  <div class="sectionCatalogList-items-prev">
						...
						<div class="sectionCatalogList-items-prev-slider__item">
                            <div class="sectionCatalogList-items-prev-slider__pic"><img class="sectionCatalogList-items-prev-slider__img" src="<?=CFile::GetPath($imggoods)?>" alt=""></div><a class="sectionCatalogList-items-prev-fast-see fastSeeShow" href="#">Быстрый просмотр</a>
                          </div>
