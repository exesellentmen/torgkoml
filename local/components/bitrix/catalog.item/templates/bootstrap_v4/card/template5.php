						...
						<?/* Старый вариант галереии*/?>
							...
							<?	foreach($item[PROPERTIES][Gallery][VALUE] as $imggoods):?>
								...
								<div class="sectionCatalogList-items-prev-slider__item">
									...
									<?
									//<img class="sectionCatalogList-items-prev-slider__img" //src="<?=CFile::GetPath($imggoods)?>" alt="">
									?>
...
<div class="gallerypvcontent">
	...
	<div class="gallerypv tabcellpv">
		<div class="qqqq">
		  <div class="scroll">
			  <div class="scroll_child" style="transform: translateX(0.888901px);">
			  ...
			  <?	foreach($item[PROPERTIES][Gallery][VALUE] as $imggoods):?>
				...
				<?/*
				<div class="elem11 " style="background-image:url(/upload/iblock/ecf/ecf1290f01e9470210472574344db9e1.jpg)"></div>
*/?>
...
<?=$item[PROPERTIES][deep][VALUE]?></div>
			...
			<?/*			  
            <div class="sectionCatalogList-items-prev-control__col two" id="<?=$itemIds['BASKET_ACTIONS']?>">
				<button class="sectionCatalogList-items-prev-price__buy black popupAddBasket__open" data-msg-ok="Добавлено" id="<?=$itemIds['BUY_LINK']?>" href="javascript:void(0)" rel="nofollow">
		...
		<?/*	<a class="buy-but1" href="javascript:void(0)" data-value="<?=$item[ID];?>">Купить 6</a> */?>
			...
			<div class="sectionCatalogList-items-prev-control__col two">
				<button class="sectionCatalogList-items-prev-price__buy black popupAddBasket__open" data-msg-ok="Добавлено">
					Добавлено
				</button>
            </div>
					...
					<?/* ========================================== */?> 
					  ...
					  <?/*
					  <img class="sectionCatalogList-items__img" src="<?=CFile::GetPath($item[PROPERTIES][Gallery][VALUE][0])?>" alt="">
					  */?>
					  ...
					  <?/*
					  <a href="<?=$itemIds['BUY_LINK']?>">Купить 4</a>
					  ...
					  ?>
						...
						<a class="buy-but" data-value="<? echo $itemIds['ADD_URL'];?>">Купить1111</a>
						
						<input class="input-sm" id="demo3_21" type="text" value="2">
						
					  */?>
					  
					  
					  <?//Разобрался с кнопкой купить?>
					  
					  
					  <?/*
					  <a href="<?=str_replace("#ID#", $item[ID], $arParams['~ADD_URL_TEMPLATE'])?>" >Купить 5</a>
					  ...
					  */?>
					  ...
					  <?/*
					  Шаблон добавления товаров
					  http://torg.vmoidom.ru/katalog-tovarov-3/?action=ADD2BASKET&id=485&quantity=5
					  */?>
					  ...
					  <?
					  /*
					  echo $arParams['~ADD_URL_TEMPLATE']."<br>";
					  echo $item[ID]."<br>";
					  */
					...
					//	print_r($arParams);
					  ...
					  <a href="/catalog/
						...
						/?<?=$arParams["ACTION_VARIABLE"]?>=ADD2BASKET&id=<?=$OFFERS['ID']?>"


						class="btn btn-primary buy_button" rel="nofollow" onclick="return addToCart(this, 'list', '<?=GetMessage("CATALOG_IN_CART")?>', 'noCart');" id="catalog_add2cart_link_<?=$OFFERS['ID']?>"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> В корзину555</a>
                    ...
                    <div class="sectionCatalogList-items-control">
                      ...
                      <?/*
						...
						<a class="buy-but" data-value="<?=$itemIds['BUY_LINK']?>">Купить 3</a>
...
<div class="tovar">
	...
	<div class="product-item-info-container product-item-price-container" data-entity="price-block">
						...
						{
							?>
							Старая цена<br><span class="product-item-price-old" id="<?=$itemIds['PRICE_OLD']?>"
								<?=($price['RATIO_PRICE'] >= $price['RATIO_BASE_PRICE'] ? 'style="display: none;"' : '')?>>
								<?=$price['PRINT_RATIO_BASE_PRICE']?>
							</span>&nbsp;
							<?
                          ...
                          <div class="sectionCatalogList-items-count">
                            ...
                            <div class="sectionCatalogList-items-count__col">
								<div class="sectionCatalogList-items-count__input">
									...
									<input class="sectionCatalogList-items-count__input-text product-item-amount-field"  id="<?=$itemIds['QUANTITY']?>" type="number"
												name="<?=$arParams['PRODUCT_QUANTITY_VARIABLE']?>"
												value="<?=$measureRatio?>">
	...
	<div class="product-item-info-container product-item-hidden" data-entity="buttons-block">
		...
		if (!$haveOffers)
		{
			if ($actualItem['CAN_BUY'])
			{
				?>
				<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
					TEST5<button class="btn btn-primary <?=$buttonSizeClass?>" id="<?=$itemIds['BUY_LINK']?>"
