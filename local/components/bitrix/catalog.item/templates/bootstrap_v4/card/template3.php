...
<a class="product-item-image-wrapper" title="<?=$imgTitle?>" data-entity="image-wrapper" style="display:none;">
...
*/?>	
	...
	<?/*
	<a title="<?=$imgTitle?>" data-entity="image-wrapper" title="<?=$imgTitle?>"  class="product-item-image-wrapper"></a>
	*/?>
