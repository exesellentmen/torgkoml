...
<?/*<div class="sectionCatalogList-items__item">*/?>
					...
					<!--
                        ...
                        <div class="sectionCatalogList-items-prev__name">Вешало напольное ST-02.60 в цвете латунь для одежды и ремней</div>
                        ...
                        <div class="sectionCatalogList-items-prev-prop">
                          <div class="sectionCatalogList-items-prev-prop__item">
                            ...
                            <div class="sectionCatalogList-items-prev-prop__value">ST-02.60</div>
                          </div>
                          <div class="sectionCatalogList-items-prev-prop__item">
                            <div class="sectionCatalogList-items-prev-prop__name">Материал</div>
                            <div class="sectionCatalogList-items-prev-prop__value">нержавейка</div>
                          </div>
                          <div class="sectionCatalogList-items-prev-prop__item">
                            <div class="sectionCatalogList-items-prev-prop__name">Цвет</div>
                            <div class="sectionCatalogList-items-prev-prop__value">латунь</div>
                          </div>
                          <div class="sectionCatalogList-items-prev-prop__item">
                            <div class="sectionCatalogList-items-prev-prop__name">Ширина, мм</div>
                            <div class="sectionCatalogList-items-prev-prop__value">900</div>
                          </div>
                          <div class="sectionCatalogList-items-prev-prop__item">
                            <div class="sectionCatalogList-items-prev-prop__name">Глубина, мм</div>
                            <div class="sectionCatalogList-items-prev-prop__value">450</div>
                          </div>
                          <div class="sectionCatalogList-items-prev-prop__item">
                            <div class="sectionCatalogList-items-prev-prop__name">Высота, мм</div>
                            <div class="sectionCatalogList-items-prev-prop__value">1500</div>
                          </div>
                        </div>
                        <div class="sectionCatalogList-items-prev-price">
                          ...
                          <div class="sectionCatalogList-items-prev-price__col two">
                            <div class="sectionCatalogList-items-prev-price__new">7 790 руб.</div>
                      ...
                      <div class="sectionCatalogList-items__pic"><img class="sectionCatalogList-items__img" src="/assest/img/imgelem1.png" alt=""></div>
                      <div class="catalogDetailProdukts-slider-mini-prop catalogSectionPropHeight">
                      </div><a class="sectionCatalogList-items__name" href="#">Вешало напольное ST-02.60 в цвете латунь для одежды и ремней в цвете латунь для одежды и ремней в цвете латунь для одежды и ремней в цвете латунь для одежды и ремней в цвете латунь для одежды и ремней</a>
                      <div class="sectionCatalogList-items-prop">
                        <div class="sectionCatalogList-items-prop__item">
                          ...
                          <div class="sectionCatalogList-items-prop__value">ST-02.60</div>
                        </div>
                        <div class="sectionCatalogList-items-prop__item">
                          <div class="sectionCatalogList-items-prop__name">Материал</div>
                          <div class="sectionCatalogList-items-prop__value">нержавейка</div>
                        </div>
                        <div class="sectionCatalogList-items-prop__item">
                          <div class="sectionCatalogList-items-prop__name">Цвет</div>
                          <div class="sectionCatalogList-items-prop__value">латунь</div>
                        </div>
                        <div class="sectionCatalogList-items-prop__item">
                          <div class="sectionCatalogList-items-prop__name">Ширина, мм</div>
                          <div class="sectionCatalogList-items-prop__value">900</div>
                        </div>
                        <div class="sectionCatalogList-items-prop__item">
                          <div class="sectionCatalogList-items-prop__name">Глубина, мм</div>
                          <div class="sectionCatalogList-items-prop__value">450</div>
                        </div>
                        <div class="sectionCatalogList-items-prop__item">
                          <div class="sectionCatalogList-items-prop__name">Высота, мм</div>
                          <div class="sectionCatalogList-items-prop__value">1500</div>
                        </div>
                      </div>
                      <div class="sectionCatalogList-items-price">
                        <div class="sectionCatalogList-items-price__new">7 790 руб.</div>
