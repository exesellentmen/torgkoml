...
JCSmartFilter.prototype.selectDropDownItem = function(element, controlId)
{
	...
	//Функция работает правильно с аналогом document.getElementById
	this.keyup(BX(controlId));
	
	//Возвращает в обоих случаях дроп доун
	...
	//alert(BX.PopupWindowManager.getCurrentPopup());
