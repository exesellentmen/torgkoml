...
<div class="sectionCatalogFilter">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					?>
                        ...
                        <div class="sectionCatalogFilter-selected__value"><?=$arItem["NAME"]?></div>
						...
						<div class="sectionCatalogFilter-selected__item active"  for="<?="all_".$arCur["CONTROL_ID"]?>"
                            ...
                            <div class="sectionCatalogFilter-selected__count">213</div>
										...
										?> 
											...
											<div class="sectionCatalogFilter-selected__item"  for="<?=$ar["CONTROL_ID"]?>"
