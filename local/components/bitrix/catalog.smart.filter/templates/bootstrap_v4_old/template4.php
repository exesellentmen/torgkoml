...
<div class="sectionCatalogFilter">
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<?
                        ...
                        <div class="sectionCatalogFilter-selected__value"><?=$arItem["NAME"]?> 
						<? if($name){echo " - $name";}?>
						</div>
						...
						<?
							...
							foreach ($arItem["VALUES"] as $val => $ar){
								if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])){
									$coun22 = $coun22 + $ar["ELEMENT_COUNT"];
								}
							}
						?> 
						...
						<div class="sectionCatalogFilter-selected__item <?=$classall?>"  for="<?="all_".$arCur["CONTROL_ID"]?>"
							...
							<?//=$coun22;?>
										...
										?> 
											...
											<div class="sectionCatalogFilter-selected__item <?=$class;?>"  for="<?=$ar["CONTROL_ID"]?>"
	...
	<?/*		
<div id="smartFilterDropDown125" class="popup-window" style="z-index: 1000;  display: block;">
	<div id="popup-window-content-smartFilterDropDown125" class="popup-window-content">
		<div class="smart-filter-dropdown-popup" data-role="dropdownContent" style="display: block;">
*/?>
...
<div class="sectionCatalogFilter">
  <div class="sectionCatalogFilter__wrap">
	...
	<div class="sectionCatalogFilter-selected">
      <div class="sectionCatalogFilter-selected__value">Цвет</div>
      ...
      <div class="sectionCatalogFilter-selected__items">
		...
		>
          <div class="sectionCatalogFilter-selected__text" for="all_arrFilter_125_1120914852"
		data-role="label_all_arrFilter_125_1120914852"
		onclick="$('#all_arrFilter_125_1120914852').prop('checked', true);
		smartFilter.selectDropDownItem(this, 'all_arrFilter_125_1120914852')">Все</div>
          <div class="sectionCatalogFilter-selected__count">213</div>
        </div>
		
        <div class="sectionCatalogFilter-selected__item"
		
		for="arrFilter_125_1120914852"
		data-role="label_arrFilter_125_1120914852"
		onclick="
		$('#arrFilter_125_1120914852').prop('checked', true);
		smartFilter.selectDropDownItem(this, 'arrFilter_125_1120914852');"
		>

          <div class="sectionCatalogFilter-selected__text" 
		  >
		  белый
		  </div>
        ...
        <div class="sectionCatalogFilter-selected__item"
		>
          <div class="sectionCatalogFilter-selected__text" for="arrFilter_125_3489983647"
		data-role="label_arrFilter_125_3489983647"
		onclick="$('#arrFilter_125_3489983647').prop('checked', true);
		smartFilter.selectDropDownItem(this, 'arrFilter_125_3489983647')">желтый</div>
...
<label 
		for="all_arrFilter_125_1120914852"
		class="smart-filter-dropdown-label"
		data-role="label_all_arrFilter_125_1120914852"
		onclick="smartFilter.selectDropDownItem(this, 'all_arrFilter_125_1120914852'); ">
			Все														
		</label>
<br>
...
<label
		for="arrFilter_125_3489983647"
		class="smart-filter-dropdown-label"
		data-role="label_arrFilter_125_3489983647"
		onclick="smartFilter.selectDropDownItem(this, 'arrFilter_125_3489983647')">
			желтый															
		</label>
<br>
...
<ul>
	...
	<li>
		...
		class="smart-filter-dropdown-label"
		data-role="label_arrFilter_125_1120914852"
		onclick="smartFilter.selectDropDownItem(this, 'arrFilter_125_1120914852')">
			белый															
		</div>
	</li>
					...
					<div class="smart-filter-block">
						<div class="smart-filter-parameters-box-container">
							...
							<div class="smart-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
								...
								<br/>
								<a href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?>
							...
							*/?>
							...
							<div style="display:none" class="hidd1" id="modef">
								<?echo GetMessage("CT_BCSF_FILTER_COUNT", array("#ELEMENT_COUNT#" => '<span id="modef_num">'.intval($arResult["ELEMENT_COUNT"]).'</span>'));?>
								<span class="arrow"></span>
								<br/>
								<a href="<?echo $arResult["FILTER_URL"]?>" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?>
