						...
						<div class="sectionCatalogFilter-selected__items">
							...
							<?foreach ($arItem["VALUES"] as $val => $ar):
								...
								if ($ar["DISABLED"])
									$class.= " ";
							?>
								<div class="sectionCatalogFilter-selected__item <?=$class;?>"  for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" onclick="$('#<?=CUtil::JSEscape($ar["CONTROL_ID"])?>').prop('checked', true); smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')">
